...
class CardUtils {
  ...
  CardUtils(this.context);

  static var test;

  String validateCVV(String value) {
    if (value.isEmpty) {
      return AppLocalizations.of(context).translate('label_field_required');
    }
  ...
  String validateDate(String value) {
    ...
    if ((month < 1) || (month > 12)) {
      ...
      return AppLocalizations.of(context).translate('label_card_month_invalid');
    }
    ...
    if ((fourDigitsYear < 1) || (fourDigitsYear > 2099)) {
      ...
      return AppLocalizations.of(context).translate('label_card_year_invalid');
    }

    if (!hasDateExpired(month, year)) {
      return AppLocalizations.of(context).translate('label_card_expired');
    }
    return null;
  }
  ...
  Widget getCardIcon(CardType cardType) {
    ...
    switch (cardType) {
      case CardType.Master:
        img = 'graphics/mastercard.png';
        break;
      case CardType.Visa:
        img = 'graphics/visa.png';
        break;
      case CardType.Verve:
        img = 'graphics/verve.png';
        break;
      case CardType.AmericanExpress:
        img = 'graphics/american_express.png';
        break;
      case CardType.Discover:
        img = 'graphics/discover.png';
        break;
      case CardType.DinersClub:
        img = 'graphics/dinners_club.png';
        break;
      case CardType.Jcb:
        img = 'graphics/jcb.png';
        break;
  ...
  String validateCardNum(String input) {
    ...
    if (input.length < 8) {
      return MyConstants.numberIsInvalid;
    }
